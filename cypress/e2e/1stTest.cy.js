...
//info: context and describe are same and have the same functionality {context is an alias of describe}
/*
context('empty spec', () => {
  it('passes', () => {
...
describe('Our First Suite',() => {
  ...
  it('First test', ()=>{
    ...
    it('Second test',() =>{
        ...
        //info: Travel through the dom
        //> 1
        cy.get('#inputEmail3').parents('form').find('button').should('contain','Sign in')
        .parents('form').find('nb-checkbox').click()


        //cy.get('[Status="warning"]').should('contain','Sign in').click()
        //cy.get('[id="inputEmail3"]').parents('[class="form-horizontal"]').find('button').click()
        //cy.get('[id="inputEmail3"]').parents('form').find('button').click()

        //> Simplifying 1, refer to the screenshot in the Understanding Dom folder
    ...
    it.only('then and wrap methods',() =>{
        ...
        //info: then() makes the parameter a jquery object i.e. firstform
        //info: this is in jquery
        ...
        //info: should() is cypress related while expect() is chai related
        //info: text() is chai related
            ...
            cy.contains('nb-card', 'Basic form').then(secondform=>{
                ...
                // wrap the jquery element secondform so we can use the cypress command
